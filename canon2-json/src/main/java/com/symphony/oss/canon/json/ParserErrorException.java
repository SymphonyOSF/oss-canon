 ...
 *
 */
public class ParserErrorException extends ParserException
{
   ...
   *        error in the input.
   */
  public ParserErrorException(String message, IParserContext context)
  {
   ...
   */
  public ParserErrorException(String message, IParserContext context, Throwable cause)
  {
   ...
   *        error in the input.
   */
  public ParserErrorException(String message, IJsonDomNodeProvider jsonProvider)
  {
   ...
   *        and indicates that the cause is nonexistent or unknown.)
   */
  public ParserErrorException(String message, IJsonDomNodeProvider jsonProvider, Throwable cause)
  {
   ...
   *        and indicates that the cause is nonexistent or unknown.)
   */
  public ParserErrorException(Exception cause)
  {
    super(FATAL, cause);
  }
}
