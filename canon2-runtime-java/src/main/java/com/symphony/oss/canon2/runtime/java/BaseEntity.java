 ...
 *
 */
public class BaseEntity implements IJsonDomNodeProvider
{
   ...
   */
  public BaseEntity(@Nonnull JsonDomNode jsonDomNode)
  {
   ...
   * @author Bruce Skingle
   *
   * @param <J> The type of json node required to serialise this type. 
   * @param <T> Concrete type of the builder.
   * @param <B> Concrete type of the built class.
   */
  public static abstract class AbstractBuilder<J extends JsonDomNode, T extends AbstractBuilder<J,T,B>, B extends BaseEntity>
...
//    }
   ...
   * @param <B> Concrete type of the built class.
   */
  public static abstract class Factory<J extends JsonDomNode, B extends BaseEntity>
  {
    /**
     ...
     */
    public abstract B newInstance(J jsonObject, ModelRegistry modelRegistry);
     ...
     * @return An instance of the entity represented by the given serialized form.
     */
    public @Nullable B newInstanceOrNull(List<ParserException> parserExceptions, J jsonObject, ModelRegistry modelRegistry)
    {
      try
      {
    ...
    public @Nullable B newInstanceOrNull(J jsonObject, ModelRegistry modelRegistry)
    {
      try
      {
         return newInstance(jsonObject, modelRegistry);
...
//    }
     ...
     * @throws ParserException  If the given JSON is not valid.
     */
    public abstract B newInstance(StringReader reader, ModelRegistry modelRegistry) throws ParserResultException;
