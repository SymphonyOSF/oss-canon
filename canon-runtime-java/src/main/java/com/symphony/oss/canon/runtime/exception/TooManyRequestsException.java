...
public class TooManyRequestsException extends CanonException
{
  ...
  private static final int HTTP_STATUS_CODE = 429;
   ...
   */
  public TooManyRequestsException(CloseableHttpResponse response)
  {
   ...
   * @param response An HTTP response which is saved as the cause of the exception.
   */
  public TooManyRequestsException(int httpStatusCode, String message, CloseableHttpResponse response)
  {
