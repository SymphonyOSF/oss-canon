...
public class ${model.parent.camelCapitalizedName}${model.camelCapitalizedName}HttpRequest extends ${model.parent.camelCapitalizedName}${model.camelCapitalizedName}HttpRequestOrBuilder
{
   ...
   *
   * @throws IllegalStateException      If the request fails for technical reasons.
   ...
   */
  public List<${methodResponseElementType}> execute(CloseableHttpClient httpClient) throws PermissionDeniedException, BadRequestException, ServerErrorException
  <#else>
  /**
   * Execute the request.
   * 
   ...
   * @throws ServerErrorException       If the request fails due to an unexpected server side error.
   */
  public ${methodResponseDecl} execute(CloseableHttpClient httpClient) throws PermissionDeniedException, BadRequestException, ServerErrorException
  </#if>
  {
