...
/**
 * Instance or Builder for Object ObjectSchema
 */
// entity.class class com.symphony.oss.canon2.generator.java.JavaObjectSchemaTemplateModel
public interface I_ObjectSchema_InstanceOrBuilder extends IObjectEntityInitialiser
{
   ...
   * @return the value of the type attribute.
   */
  @Nonnull ObjectSchema.Type getType();
   ...
   * @return the value of the properties attribute.
   */
  @Nonnull PropertiesObject getProperties();
