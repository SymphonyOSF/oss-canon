...
/**
 * Instance or Builder for Object ArraySchema
 */
// entity.class class com.symphony.oss.canon2.generator.java.JavaObjectSchemaTemplateModel
public interface I_ArraySchema_InstanceOrBuilder extends IObjectEntityInitialiser
{
   ...
   * @return the value of the minItems attribute.
   */
  @Nullable ArraySchema.MinItems getMinItems();
   ...
   * @return the value of the maxItems attribute.
   */
  @Nullable ArraySchema.MaxItems getMaxItems();
   ...
   * @return the value of the type attribute.
   */
  @Nonnull ArraySchema.Type getType();
