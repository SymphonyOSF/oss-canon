 ...
 *
 */
public class ResolvedDoubleSchema extends ResolvedNumberSchema
{
   ...
   */
  public abstract static class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends ResolvedDoubleSchema> extends ResolvedNumberSchema.AbstractBuilder<T,B>
  {
    ...
    public T withMinimum(JsonDomNode json)
    {
      ...
      else if(json instanceof JsonParsedNumber)
      {
        try
        {
          minimum_ = ((JsonParsedNumber)json).asDouble();
        }
    ...
    public T withMaximum(JsonDomNode json)
    {
      ...
      else if(json instanceof JsonParsedNumber)
      {
        try
        {
          maximum_ = ((JsonParsedNumber)json).asDouble();
        }
        catch(NumberFormatException e)
        {
