 ...
 */
@Immutable
public abstract class BooleanSchemaEntity extends ObjectEntity
{
  /** Type ID */
   ...
   */
  public BooleanSchemaEntity(Initialiser initialiser)
  {
    super(initialiser);
...
// schema.class class com.symphony.oss.canon2.generator.java.JavaStringSchemaTemplateModel name x-canon-identifier type String javaType String
      ...
      else
      {
        if(node instanceof JsonString)
        {
// schema.class class com.symphony.oss.canon2.generator.java.JavaStringSchemaTemplateModel name type type BooleanSchema.Type javaType String
...
// schema.class class com.symphony.oss.canon2.generator.java.JavaBooleanSchemaTemplateModel name x-canon-facade type Boolean javaType Boolean
    ...
    {
      IBooleanSchemaInstanceOrBuilder builder =  initialiser.getInstanceOrBuilder();
  ...
  public interface Initialiser extends IObjectEntityInitialiser
  {
     ...
     * @return an instance or builder containing the values for a new instance.
     */
    IBooleanSchemaInstanceOrBuilder getInstanceOrBuilder();
  }
  ...
  public static class JsonInitialiser extends JsonObjectEntityInitialiser implements Initialiser
  {
    ...
    @Override
    public IBooleanSchemaInstanceOrBuilder getInstanceOrBuilder()
    {
      return null;
    }
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends BooleanSchemaEntity>
// super class name
    extends ObjectEntity.AbstractBuilder<T,B>
    implements IBooleanSchemaInstanceOrBuilder, Initialiser
  {
...
// schema.class class com.symphony.oss.canon2.generator.java.JavaBooleanSchemaTemplateModel name x-canon-facade type Boolean javaType Boolean
     ...
     * @return This (fluent method).
     */
    public T withType(BooleanSchema.Type value) //main
    {
        if(value == null)
          throw new IllegalArgumentException("type is required.");
    ...
    public JsonObject getJson()
    {
      ...
      builder.addIfNotNull(JSON_TYPE, BooleanSchemaEntity.TYPE_ID);
      builder.addIfNotNull(JSON_VERSION, BooleanSchemaEntity.TYPE_VERSION);
  ...
  {
    if(obj instanceof BooleanSchemaEntity)
      return toString().equals(((BooleanSchemaEntity)obj).toString());
