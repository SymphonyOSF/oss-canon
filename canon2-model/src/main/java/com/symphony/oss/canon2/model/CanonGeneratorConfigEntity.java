...
/**
 * Implementation for Object  CanonGeneratorConfig canon
 ...
 */
@Immutable
public abstract class CanonGeneratorConfigEntity extends ObjectEntity
{
  /** Type ID */
   ...
   */
  public CanonGeneratorConfigEntity(AbstractBuilder<?,?> builder)
  {
    super(builder);
   ...
   */
  public CanonGeneratorConfigEntity(JsonObject jsonObject, ModelRegistry modelRegistry)
  {
    super(jsonObject);
   ...
   */
  public CanonGeneratorConfigEntity(CanonGeneratorConfig other)
  {
    super(other);
  ...
  {
    if(obj instanceof CanonGeneratorConfigEntity)
      return toString().equals(((CanonGeneratorConfigEntity)obj).toString());
   ...
   */
  public static class Factory extends ObjectEntity.Factory<CanonGeneratorConfigEntity>
  {
    @Override
    ...
    @Override
    public CanonGeneratorConfig newInstance(JsonObject jsonObject, ModelRegistry modelRegistry)
    {
      return new CanonGeneratorConfig(jsonObject, modelRegistry);
    }
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends CanonGeneratorConfigEntity>
    extends ObjectEntity.AbstractBuilder<T,B>
  {
    ...
    public JsonObject getJsonObject()
    {
      ...
      builder.addIfNotNull(JSON_TYPE, CanonGeneratorConfigEntity.TYPE_ID);
      builder.addIfNotNull(JSON_VERSION, CanonGeneratorConfigEntity.TYPE_VERSION);
  ...
  // entity.name CanonGeneratorConfig
