...
/**
 * Facade for Object  PathsObject canon
 ...
 */
@Immutable
public class PathsObject extends PathsObjectEntity
{
  /**
   ...
   */
  public PathsObject(AbstractBuilder<?,?> builder)
  {
    super(builder);
  }
   ...
   */
  public PathsObject(JsonObject jsonObject, ModelRegistry modelRegistry)
  {
   ...
   */
  public PathsObject(PathsObject other)
  {
    super(other);
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends PathsObject> extends PathsObjectEntity.AbstractBuilder<T,B>
  {
