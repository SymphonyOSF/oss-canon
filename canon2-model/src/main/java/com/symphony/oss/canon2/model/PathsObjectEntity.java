...
/**
 * Implementation for Object  PathsObject canon
 ...
 */
@Immutable
public abstract class PathsObjectEntity extends ObjectEntity
{
  /** Type ID */
   ...
   */
  public PathsObjectEntity(AbstractBuilder<?,?> builder)
  {
    super(builder);
   ...
   */
  public PathsObjectEntity(JsonObject jsonObject, ModelRegistry modelRegistry)
  {
    super(jsonObject);
   ...
   */
  public PathsObjectEntity(PathsObject other)
  {
    super(other);
  ...
  {
    if(obj instanceof PathsObjectEntity)
      return toString().equals(((PathsObjectEntity)obj).toString());
   ...
   */
  public static class Factory extends ObjectEntity.Factory<PathsObjectEntity>
  {
    @Override
    ...
    {
      return new PathsObject(jsonObject, modelRegistry);
    }
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends PathsObjectEntity>
    extends ObjectEntity.AbstractBuilder<T,B>
  {
    ...
    public JsonObject getJsonObject()
    {
      ...
      builder.addIfNotNull(JSON_TYPE, PathsObjectEntity.TYPE_ID);
      builder.addIfNotNull(JSON_VERSION, PathsObjectEntity.TYPE_VERSION);
