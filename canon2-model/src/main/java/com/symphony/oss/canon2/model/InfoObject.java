...
public class InfoObject extends InfoObjectEntity
{
   ...
   */
  public InfoObject(AbstractBuilder<?,?> builder)
  {
    super(builder);
  }
   ...
   */
  public InfoObject(JsonObject jsonObject, ModelRegistry modelRegistry)
  {
   ...
   */
  public InfoObject(InfoObject other)
  {
    super(other);
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends InfoObject> extends InfoObjectEntity.AbstractBuilder<T,B>
  {
