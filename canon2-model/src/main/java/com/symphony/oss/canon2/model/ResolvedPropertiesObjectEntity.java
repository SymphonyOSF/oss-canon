...
/**
 * Implementation for Object  ResolvedPropertiesObject canon
 ...
 */
@Immutable
public abstract class ResolvedPropertiesObjectEntity extends ObjectEntity
{
  /** Type ID */
  public static final String  TYPE_ID = "com.symphony.oss.canon2.model.ResolvedPropertiesObject";
  /** Type version */
   ...
   */
  public ResolvedPropertiesObjectEntity(AbstractBuilder<?,?> builder)
  {
    super(builder);
   ...
   */
  public ResolvedPropertiesObjectEntity(JsonObject jsonObject, ModelRegistry modelRegistry)
  {
    super(jsonObject);
   ...
   */
  public ResolvedPropertiesObjectEntity(ResolvedPropertiesObject other)
  {
    super(other);
  ...
  {
    if(obj instanceof ResolvedPropertiesObjectEntity)
      return toString().equals(((ResolvedPropertiesObjectEntity)obj).toString());
  ...
  /**
   * Factory class for ResolvedPropertiesObject.
   */
  public static class Factory extends ObjectEntity.Factory<ResolvedPropertiesObjectEntity>
  {
    @Override
    ...
    @Override
    public ResolvedPropertiesObject newInstance(JsonObject jsonObject, ModelRegistry modelRegistry)
    {
      return new ResolvedPropertiesObject(jsonObject, modelRegistry);
    }
  }
  ...
  /**
   * Builder for ResolvedPropertiesObject
   */
  public static class Builder extends ResolvedPropertiesObject.AbstractBuilder<Builder, ResolvedPropertiesObject>
  {
    /**
     * Constructor.
     */
     ...
     */
    public Builder(ResolvedPropertiesObject initial)
    {
      super(Builder.class, initial);
    }

    @Override
    protected ResolvedPropertiesObject construct()
    {
      return new ResolvedPropertiesObject(this);
    }
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends ResolvedPropertiesObjectEntity>
    extends ObjectEntity.AbstractBuilder<T,B>
  {
    ...
    public JsonObject getJsonObject()
    {
      ...
      builder.addIfNotNull(JSON_TYPE, ResolvedPropertiesObjectEntity.TYPE_ID);
      builder.addIfNotNull(JSON_VERSION, ResolvedPropertiesObjectEntity.TYPE_VERSION);
  ...
  // entity.name ResolvedPropertiesObject
