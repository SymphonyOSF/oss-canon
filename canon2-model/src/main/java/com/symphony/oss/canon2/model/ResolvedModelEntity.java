...
/**
 * Implementation for Object  ResolvedModel canon
 ...
 */
@Immutable
public abstract class ResolvedModelEntity extends OpenApiObject
{
  /** Type ID */
  public static final String  TYPE_ID = "com.symphony.oss.canon2.model.ResolvedModel";
  /** Type version */
   ...
   */
  public ResolvedModelEntity(AbstractBuilder<?,?> builder)
  {
    super(builder);
   ...
   */
  public ResolvedModelEntity(JsonObject jsonObject, ModelRegistry modelRegistry)
  {
   ...
   */
  public ResolvedModelEntity(ResolvedModel other)
  {
    super(other);
  ...
  {
    if(obj instanceof ResolvedModelEntity)
      return toString().equals(((ResolvedModelEntity)obj).toString());
  ...
  /**
   * Factory class for ResolvedModel.
   */
  public static class Factory extends ObjectEntity.Factory<ResolvedModelEntity>
  {
    @Override
    ...
    @Override
    public ResolvedModel newInstance(JsonObject jsonObject, ModelRegistry modelRegistry)
    {
      return new ResolvedModel(jsonObject, modelRegistry);
    }
  }
  ...
  /**
   * Builder for ResolvedModel
   */
  public static class Builder extends ResolvedModel.AbstractBuilder<Builder, ResolvedModel>
  {
    /**
     * Constructor.
     */
     ...
     */
    public Builder(ResolvedModel initial)
    {
      super(Builder.class, initial);
    }

    @Override
    protected ResolvedModel construct()
    {
      return new ResolvedModel(this);
    }
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends ResolvedModelEntity>
    extends OpenApiObject.AbstractBuilder<T,B>
  {
    ...
    public JsonObject getJsonObject()
    {
      ...
      builder.addIfNotNull(JSON_TYPE, ResolvedModelEntity.TYPE_ID);
      builder.addIfNotNull(JSON_VERSION, ResolvedModelEntity.TYPE_VERSION);
