...
/**
 * Instance or Builder for Object SchemaOrRef
 */
// entity.class class com.symphony.oss.canon2.generator.java.JavaObjectSchemaTemplateModel
public interface I_SchemaOrRef_InstanceOrBuilder extends IEntityInitialiser
{
   ...
   * @return the value of the ReferenceObject attribute.
   */
  @Nullable ReferenceObject getReferenceObject();
