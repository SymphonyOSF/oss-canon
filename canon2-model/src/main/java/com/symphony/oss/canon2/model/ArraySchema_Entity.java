 ...
 */
@Immutable
public abstract class ArraySchema_Entity extends ObjectEntity
{
  /** Type ID */
   ...
   */
  public ArraySchema_Entity(Initialiser initialiser)
  {
    super(initialiser);
    ...
    {
      I_ArraySchema_InstanceOrBuilder builder =  initialiser.getInstanceOrBuilder();
  ...
  public interface Initialiser extends IObjectEntityInitialiser
  {
     ...
     * @return an instance or builder containing the values for a new instance.
     */
    I_ArraySchema_InstanceOrBuilder getInstanceOrBuilder();
  }
  ...
  public static class JsonInitialiser extends JsonObjectEntityInitialiser implements Initialiser
  {
    ...
    @Override
    public I_ArraySchema_InstanceOrBuilder getInstanceOrBuilder()
    {
      return null;
    }
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends ArraySchema_Entity>
    extends ObjectEntity.AbstractBuilder<T,B>
    implements I_ArraySchema_InstanceOrBuilder, Initialiser
  {
    ...
    public JsonObject getJson()
    {
      ...
      builder.addIfNotNull(JSON_TYPE, ArraySchema_Entity.TYPE_ID);
      builder.addIfNotNull(JSON_VERSION, ArraySchema_Entity.TYPE_VERSION);
  ...
  {
    if(obj instanceof ArraySchema_Entity)
      return toString().equals(((ArraySchema_Entity)obj).toString());
