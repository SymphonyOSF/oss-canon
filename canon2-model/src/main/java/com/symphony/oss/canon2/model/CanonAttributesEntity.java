...
/**
 * Implementation for Object  CanonAttributes canon
 ...
 */
@Immutable
public abstract class CanonAttributesEntity extends ObjectEntity
{
  /** Type ID */
   ...
   */
  public CanonAttributesEntity(AbstractBuilder<?,?> builder)
  {
    super(builder);
   ...
   */
  public CanonAttributesEntity(JsonObject jsonObject, ModelRegistry modelRegistry)
  {
    super(jsonObject);
   ...
   */
  public CanonAttributesEntity(CanonAttributes other)
  {
    super(other);
  ...
  {
    if(obj instanceof CanonAttributesEntity)
      return toString().equals(((CanonAttributesEntity)obj).toString());
   ...
   */
  public static class Factory extends ObjectEntity.Factory<CanonAttributesEntity>
  {
    @Override
    ...
    {
      return new CanonAttributes(jsonObject, modelRegistry);
    }
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends CanonAttributesEntity>
    extends ObjectEntity.AbstractBuilder<T,B>
  {
    ...
    public JsonObject getJsonObject()
    {
      ...
      builder.addIfNotNull(JSON_TYPE, CanonAttributesEntity.TYPE_ID);
      builder.addIfNotNull(JSON_VERSION, CanonAttributesEntity.TYPE_VERSION);
