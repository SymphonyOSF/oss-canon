 ...
 */
@Immutable
public abstract class PropertiesObjectEntity extends ObjectEntity
{
  /** Type ID */
   ...
   */
  public PropertiesObjectEntity(Initialiser initialiser)
  {
    super(initialiser);
    ...
    {
      IPropertiesObjectInstanceOrBuilder builder =  initialiser.getInstanceOrBuilder();
  ...
  {
    if(obj instanceof PropertiesObjectEntity)
      return toString().equals(((PropertiesObjectEntity)obj).toString());
  ...
  public static class Factory extends ObjectEntity.Factory<PropertiesObject>
  {
    ...
    @Override
    public PropertiesObject newInstance(JsonObject jsonObject, ModelRegistry modelRegistry)
    {
      return new PropertiesObject(new JsonInitialiser(jsonObject, modelRegistry));
    }
  }

  /**
   * Initialiser for PropertiesObject
   */
  
  public interface Initialiser extends IObjectEntityInitialiser
  {
    IPropertiesObjectInstanceOrBuilder getInstanceOrBuilder();
  }
  ...
  public static class JsonInitialiser extends JsonObjectEntityInitialiser implements Initialiser
  {
    ...
    @Override
    public IPropertiesObjectInstanceOrBuilder getInstanceOrBuilder()
    {
      return null;
    }
  }
   ...
   */
  public static abstract class AbstractBuilder<T extends AbstractBuilder<T,B>, B extends PropertiesObjectEntity>
    extends ObjectEntity.AbstractBuilder<T,B>
    implements IPropertiesObjectInstanceOrBuilder, Initialiser
  {
    ...
    public JsonObject getJsonObject()
    {
      ...
      builder.addIfNotNull(JSON_TYPE, PropertiesObjectEntity.TYPE_ID);
      builder.addIfNotNull(JSON_VERSION, PropertiesObjectEntity.TYPE_VERSION);
