...
/**
 * Implementation for Object  PropertiesObject canon
...
public abstract class PropertiesObjectEntity extends ObjectEntity
{
   ...
   */
  public PropertiesObjectEntity(AbstractBuilder<?,?> builder)
  {
    super(builder);
   ...
   */
  public PropertiesObjectEntity(JsonObject jsonObject, ModelRegistry modelRegistry)
  {
    super(jsonObject);
   ...
   */
  public PropertiesObjectEntity(PropertiesObject other)
  {
    super(other);
   ...
   */
  public static class Factory extends ObjectEntity.Factory<PropertiesObjectEntity>
  {
    @Override
    ...
    {
      return new PropertiesObject(jsonObject, modelRegistry);
    }
  }
